...
export DISK_DIR_01_P="$working_path/$Job_title/01/output_P/"
export DISK_DIR_01_S="$working_path/$Job_title/01/output_S/"
...
export DISK_DIR_02_P="$working_path/$Job_title/02/output_P/"
export DISK_DIR_02_S="$working_path/$Job_title/02/output_S/"
...
if $ReStart; then
    ...
    mkdir -p $DISK_DIR_01_P $DISK_DIR_01_S
    mkdir -p $DISK_DIR_02_P $DISK_DIR_02_S

    echo "prepare starting model ..."
    cp -r $initial_velocity_dir    $DISK_DIR_01/m_current
    cp -r $initial_velocity_dir    $DISK_DIR_01_S/m_current
    cp -r $initial_velocity_dir    $DISK_DIR_01_P/m_current
    cp -r $initial_velocity_dir    $DISK_DIR_02/m_current
    cp -r $initial_velocity_dir    $DISK_DIR_02_S/m_current
    cp -r $initial_velocity_dir    $DISK_DIR_02_P/m_current
else
    echo
...
do
    ...
    cp -r $SUBMIT_DIR/parameter_S $SUBMIT_DIR/parameter
    source $SUBMIT_DIR/parameter
    rm -rf $SUBMIT_DIR/DATA/SOURCES
    cp -r $SUBMIT_DIR/DATA/SOURCES_S $SUBMIT_DIR/DATA/SOURCES
    rm -rf $DISK_DIR_01/*
    cp -r  $DISK_DIR_01_S/* $DISK_DIR_01
    ...
    do
        ...
        step_length_01=0.0
        ./bin/data_misfit_01.exe $iter $step_length_01 $compute_adjoint $NPROC_SPECFEM $DISK_DIR_01 2> ./job_info/error_sum_misfit_01_$iter
        ...
        do
            ...
            echo "sum data misfit ...... "
            mkdir -p $DISK_DIR_01/data_misfit
            ./bin/data_misfit_01.exe $iter $step_length_01 $compute_adjoint $NPROC_SPECFEM  $DISK_DIR_01 2> ./job_info/error_sum_misfit_01
            ...
            then
                ...
                cp -r  $DISK_DIR_01/m_current/* $DISK_DIR_01_P/m_current
                cp -r  $DISK_DIR_01/m_current/* $DISK_DIR_02_S/m_current
                cp -r  $DISK_DIR_01/m_current/* $DISK_DIR_02_P/m_current
                cp -r  $DISK_DIR_01/* $DISK_DIR_01_S
                break 
            fi
    ...
    cp -r $SUBMIT_DIR/DATA/SOURCES_S $SUBMIT_DIR/DATA/SOURCES
    rm -rf $DISK_DIR_02/*
    cp -r  $DISK_DIR_02_S/* $DISK_DIR_02 
    ...
    do
        ...
        step_length_02=0.0
        ./bin/data_misfit_02.exe $iter $step_length_02 $compute_adjoint $NPROC_SPECFEM $DISK_DIR_02 2> ./job_info/error_sum_misfit_02_$iter
        ...
        do
            ...
            echo "sum data misfit ...... "
            mkdir -p $DISK_DIR_02/data_misfit
            ./bin/data_misfit_02.exe $iter $step_length_02 $compute_adjoint $NPROC_SPECFEM  $DISK_DIR_02 2> ./job_info/error_sum_misfit_02
            ...
            then
                ...
                cp -r  $DISK_DIR_02/m_current/* $DISK_DIR_02_P/m_current
                cp -r  $DISK_DIR_02/m_current/* $DISK_DIR_01_S/m_current
                cp -r  $DISK_DIR_02/m_current/* $DISK_DIR_01_P/m_current
                cp -r  $DISK_DIR_02/* $DISK_DIR_02_S
                break 
            fi
    ...
    cp -r $SUBMIT_DIR/parameter_P $SUBMIT_DIR/parameter
    source $SUBMIT_DIR/parameter
    rm -rf $SUBMIT_DIR/DATA/SOURCES
    cp -r $SUBMIT_DIR/DATA/SOURCES_P $SUBMIT_DIR/DATA/SOURCES
    rm -r $DISK_DIR_01/*
    cp -r $DISK_DIR_01_P/* $DISK_DIR_01 
    ...
    do
        ...
        do
            ...
            then
                ...
                cp $DISK_DIR_01/m_try/proc* $DISK_DIR_01/m_current/
                cp -r  $DISK_DIR_01/m_current/*   $SUBMIT_RESULT/m_$iter
                cp -r  $DISK_DIR_01/m_current/* $DISK_DIR_01_S/m_current
                cp -r  $DISK_DIR_01/m_current/* $DISK_DIR_02_S/m_current
                cp -r  $DISK_DIR_01/m_current/* $DISK_DIR_02_P/m_current
                cp -r  $DISK_DIR_01/* $DISK_DIR_01_P
                break 
            fi
    ...
    cp -r $SUBMIT_DIR/DATA/SOURCES_P $SUBMIT_DIR/DATA/SOURCES
    rm -rf $DISK_DIR_02/*
    cp -r  $DISK_DIR_02_P/* $DISK_DIR_02 
    ...
    do
        ...
        do
            ...
            then
                ...
                cp $DISK_DIR_02/m_try/proc* $DISK_DIR_02/m_current/
                cp -r  $DISK_DIR_02/m_current/*   $SUBMIT_RESULT/m_$iter
                cp -r  $DISK_DIR_02/m_current/* $DISK_DIR_02_S/m_current
                cp -r  $DISK_DIR_02/m_current/* $DISK_DIR_01_S/m_current
                cp -r  $DISK_DIR_02/m_current/* $DISK_DIR_01_P/m_current
                cp -r  $DISK_DIR_02/* $DISK_DIR_02_P
                break 
            fi
