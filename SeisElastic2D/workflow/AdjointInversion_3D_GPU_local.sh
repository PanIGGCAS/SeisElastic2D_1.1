...
do
    ...
    bash $SCRIPTS_DIR/Adjoint_3D_local.sh $velocity_dir $compute_adjoint 2> ./job_info/error_current_$iter
    ...
    do
        ...
        bash $SCRIPTS_DIR/Adjoint_3D_local.sh $velocity_dir $compute_adjoint 2> ./job_info/error_update_$iter
