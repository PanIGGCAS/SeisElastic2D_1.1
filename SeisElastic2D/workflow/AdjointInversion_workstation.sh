...
bash $SCRIPTS_DIR/prepare_data_workstation.sh $velocity_dir 2> ./job_info/error_target
...
do
    ...
    bash $SCRIPTS_DIR/Adjoint_workstation.sh $velocity_dir $compute_adjoint 2> ./job_info/error_current_$iter
    ...
    do
        ...
        bash $SCRIPTS_DIR/Adjoint_workstation.sh $velocity_dir $compute_adjoint 2> ./job_info/error_update_$iter
