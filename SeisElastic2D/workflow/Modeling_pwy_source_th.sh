...
if [ $system == 'slurm' ]; then
#    srun -n 128 -c $NPROC_SPECFEM -l -W 0 $SCRIPTS_DIR/prepare_data_pwy_source.sh $velocity_dir 2> ./job_info/error_target
    srun -n 72 -l -W 0 $SCRIPTS_DIR/prepare_data_pwy_source.sh $velocity_dir 2> ./job_info/error_target
elif [ $system == 'pbs' ]; then
