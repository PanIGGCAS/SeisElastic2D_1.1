        !COMPILER-GENERATED INTERFACE MODULE: Fri May 22 16:58:38 2020
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE COMPUTE_FORCES_VISCOELASTIC_KL__genmod
          INTERFACE 
            SUBROUTINE COMPUTE_FORCES_VISCOELASTIC_KL(ACCEL_ELASTIC,    &
     ...
     &          TIME_STEPPING_SCHEME
              ...
              REAL(KIND=4) :: E1_X(5,5,NSPEC_ALLOCATE,N_SLS)
              REAL(KIND=4) :: E1_Z(5,5,NSPEC_ALLOCATE,N_SLS)
            END SUBROUTINE COMPUTE_FORCES_VISCOELASTIC_KL
          END INTERFACE 
        END MODULE COMPUTE_FORCES_VISCOELASTIC_KL__genmod
